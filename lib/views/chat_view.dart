...
class _ChatScreenState extends State<ChatScreen> {
  ...
  @override
  void initState() {
    databaseMethods.getChatMessage(widget.ChatRoomID)
    .then((val){
        setState(() {
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(widget.ChatRoomID.replaceAll("_", "").replaceAll(Constants.currentUser, "").toUpperCase(),style: TextStyle( fontSize: 16 ,fontWeight: FontWeight.w600)),
                  SizedBox(height: 6),
